...
func Test_FindDistanceToCross(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run("", func(t *testing.T) {
			d := FindDistanceToCross(tc.wireOne, tc.wireTwo)
			assert.Equal(t, d, tc.expectedDistance)
		})
	}
}

func Test_FindCrossPoints(t *testing.T) {
	testCases := []struct {
		wireOne         string
		wireTwo         string
...
func Test_FindBestSteps(t *testing.T) {
	testCases := []struct {
		wireOne string
		wireTwo string
		exp     int
	...
	for _, tc := range testCases {
		t.Run("", func(t *testing.T) {
			o := FindBestSteps(tc.wireOne, tc.wireTwo)
			assert.Equal(t, tc.exp, o)
		})
	}
}

func Test_PointsFromString(t *testing.T) {
	testCases := []struct {
		wire     string
		expected []point
	}{
	...
	for _, tc := range testCases {
		t.Run("", func(t *testing.T) {
			p := PointsFromString(tc.wire)

			assert.ElementsMatch(t, p, tc.expected)
		})
	}
}
...
func Test_ManhattanDistance(t *testing.T) {
	...
	for _, tc := range testCase {
		t.Run("", func(t *testing.T) {
			point := point{x: tc.x, y: tc.y}

			assert.Equal(t, point.ManhattanDistance(), tc.r)
		})
	}
}
